...
::-webkit-scrollbar-thumb
{
  ...
  border-bottom-color: blue;
	...
	.piece{border-radius: 2px;padding: 2% 0 0 0; font-size: 18px; float: left; width: 100%;}
	.table{border: none;}
	.sidebar1{padding: 5% 0 0 0;}
#footer {background: white;clear: both;min-height: 40px;width: 100%;font-family:Helvetica, Arial, Sans-serif;color: blue;text-align:center;
...
//}
	...
	$dbname = "mydb1863";
		...
		$term = htmlspecialchars($_POST['idnumber2']);
		$sql="SELECT impression, id, raw_json FROM twitter_statuses WHERE raw_json LIKE '%" . $term . "%' ORDER BY impression DESC LIMIT 5";
		$results = array();
		$pop = array();
